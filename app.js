...
/*──── ADVERTISEMENT DATA ────*/
const AD_ICONS = {
  coursera: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>`,
  internship: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><line x1="12" y1="12" x2="12" y2="16"/><line x1="10" y1="14" x2="14" y2="14"/></svg>`,
  ai: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h.01M15 9h.01M9 15h6"/></svg>`,
  notion: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>`,
  nptel: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>`,
  grammarly: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>`,
};

const ADS = [
  { icon: AD_ICONS.coursera,   title: 'Coursera Plus — 7 Days Free',   desc: 'Access 7000+ courses. Start learning today!',              url: '#' },
  { icon: AD_ICONS.internship, title: 'Internshala Internships',        desc: 'Find top internships for students near you.',               url: '#' },
  { icon: AD_ICONS.ai,         title: 'ChatGPT Plus for Students',      desc: 'Get GPT-4 at 50% off with student email.',                 url: '#' },
  { icon: AD_ICONS.notion,     title: 'Notion for Education',           desc: 'Free Notion Pro plan for students & teachers.',            url: '#' },
  { icon: AD_ICONS.nptel,      title: 'NPTEL Courses — Free',           desc: 'Government-certified free courses. Enroll now.',           url: '#' },
  { icon: AD_ICONS.grammarly,  title: 'Grammarly Premium',              desc: 'Perfect your assignments with Grammarly AI.',              url: '#' },
];
/*──── LEADERBOARD DATA ────*/
